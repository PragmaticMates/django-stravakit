...
class DashboardView(AthleteScopedMixin, TemplateView):
    template_name = 'stravakit/pages/dashboard.html'
    ...
    def get_template_names(self):
        ...
        if getattr(self.request, 'htmx', False):
            return ['stravakit/hx/dashboard_results.html']
...
class RefreshView(UserPassesTestMixin, DashboardView):
    ...
    template_name = 'stravakit/hx/dashboard_refresh.html'
    error_template_name = 'stravakit/hx/dashboard_refresh_error.html'
...
class ActivitiesView(AthleteScopedMixin, ListView):
    model = Activity
    template_name = 'stravakit/pages/activities.html'
    context_object_name = 'activities'

    def get_template_names(self):
        if getattr(self.request, 'htmx', False):
            return ['stravakit/hx/activities_results.html']
        return [self.template_name]
...
class GearView(AthleteScopedMixin, ListView):
    model = Gear
    template_name = 'stravakit/pages/gear.html'
    context_object_name = 'gear_list'

    def get_template_names(self):
        if getattr(self.request, 'htmx', False):
            return ['stravakit/hx/gear_results.html']
        return [self.template_name]
...
class GalleryView(AthleteScopedMixin, ListView):
    model = Activity
    template_name = 'stravakit/pages/gallery.html'
    context_object_name = 'photos'

    def get_template_names(self):
        if getattr(self.request, 'htmx', False):
            return ['stravakit/hx/gallery_results.html']
        return [self.template_name]
...
class ActivityCardView(DetailView):
    ...
    model = Activity
    template_name = 'stravakit/widgets/activity.html'
...
def oauth_connect(request):
    ...
    redirect_uri = request.build_absolute_uri(reverse('stravakit:oauth_callback'))
...
def oauth_callback(request):
    ...
    if request.GET.get('error'):
        ...
        return redirect('admin:stravakit_athlete_changelist')
    ...
    return redirect('admin:stravakit_athlete_change', athlete.pk)
